...
<body>
    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
			...
			<h1>Clothes Donations</h1>
			<table border="2">
			<tr>
			<th><center style="width: 150px;">Donor</center></th>
			<th><center style="width: 150px;">Food Type</center></th>
			...
			<%
			String donor = (String) session.getAttribute("tname");
			Statement st = con.createStatement();
			ResultSet rs = st.executeQuery(" select * from clothes where tname = '"+donor+"' ");
			while(rs.next()){%>
				<tr>
				...
				<td><center style="width: 150px;"><a href="images/<%=rs.getString(6)%>" target="_blank">View</a></center></td>
				</tr>
			<%}%>
			</table></center>
            </div>
