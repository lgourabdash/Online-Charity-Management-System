...
<body>
    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
			...
			<th><center style="width: 150px;">Bank Name</center></th>
			<th><center style="width: 150px;">Amount</center></th>
			</tr>
			<%
			String donor = (String) session.getAttribute("cemail");
			Statement st = con.createStatement();
			ResultSet rs = st.executeQuery(" select * from money where donor = '"+donor+"' ");
			while(rs.next()){%>
				<tr>
				<td><center style="width: 150px;"><%=rs.getString(9)%></center></td>
				<td><center style="width: 150px;"><%=rs.getString(4)%></center></td>
				<td><center style="width: 150px;"><%=rs.getString(8)%></center></td>
				</tr>
			<%}%>
			</table></center>
            </div>
