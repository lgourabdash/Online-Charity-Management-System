    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
			...
			<div><center>
				...
				<tr><td><input type="text" name="foodtype" placeholder="Enter Food Type" required style="margin-bottom: 30px;"></td></tr>
				<tr><td><input type="text" name="quantity" placeholder="Enter Quantity" required style="margin-bottom: 30px;"></td></tr>
