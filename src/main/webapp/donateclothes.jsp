...
<body>
    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
			...
			<div><center>
				<form action="donateclothes1.jsp" method="post" enctype="multipart/form-data">
				<br><br>
				...
				<tr><td style="margin-bottom: 30px;"><h4>Clothes For</h4></td></tr>
				<tr><td><select name="clothestype" required style="margin-bottom: 30px;">
				...
				<tr><td><input type="text" name="quantity" placeholder="Enter Pairs (Count)" required style="margin-bottom: 30px;"></td></tr>
